...
import {Media,Button,Alert,FormControl,Glyphicon,Col,Row,Modal,ButtonToolbar} from 'react-bootstrap'
    ...
    <div>
        ...
        >
          ...
          <Modal.Body>
            ...
            <img  alt={articles.poster_path} src={`https://image.tmdb.org/t/p/w185_and_h278_bestv2/${articles.backdrop_path}`}/>
            </Media.Left>
            <Media.Body>
            <p>
